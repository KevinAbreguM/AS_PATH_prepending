...
'''
def representacion_pie(tamaño,lista,labels,title_leyenda,title,num_imagen,fecha,url_imagen,nombre):
    
	#Creo la figura de 1 fila y 1 columna del tamaño indicado
    fig,ax = plt.subplots(figsize = tamaño,subplot_kw = dict(aspect="equal"))
...
'''representacion_1_figura_diccionarios:
	...
	una URL
'''
def representacion_1_figura_diccionarios(diccionario,tamaño,bar_width,opacity,
    ...
    #Creo la figura de 1 fila y 1 columna del tamaño indicado
    fig,ax = plt.subplots(nrows = 1, ncols = 1,figsize=tamaño)
...
'''representacion_1_figura_lista_ordenada:
	...
	una URL
'''
def representacion_1_figura_lista_ordenada(lista,tamaño,bar_width,opacity,
...
'''representacion_1_figura_contadores:
	...
	una URL
'''
def representacion_1_figura_contadores(contador,tamaño,ylabel,xlabel,title,num_imagen,fecha,url):
...
def representacion_1_figura_lista(lista,labels_lista,tamaño,ylabel,xlabel,title,num_imagen,fecha,url,bar_width,opacity,rotation):
...
title = ""
num_imagen = representacion_1_figura_lista(lista_info_final,labels_dicc,(10,5),"Número ASes Transito distintos",
...
title = ""
num_imagen = representacion_1_figura_lista(lista_info_final_porcentaje,labels_dicc,(10,5),"Número ASes Transito distintos",
                "Monitor",title,num_imagen,fecha,url_imagen,bar_width,opacity,'vertical')
...
title = ""
num_imagen = representacion_1_figura_lista(lista_info_final_filtrado,labels_dicc,(10,5),"Número ASes Transito distintos",
                "Monitor",title,num_imagen,fecha,url_imagen,bar_width,opacity,'vertical')
