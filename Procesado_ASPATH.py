...
# -*- coding: utf-8 -*-
"""
Funcion que procesa la informacion de los CSVs a nivel AS_PATH y 
...
def informacion_cantidad_prefijos_anunciados(data,umbral):
	...
	#Añado el nombre de cada categoria
...
'''
def representacion_pie(tamaño,lista,labels,title_leyenda,title,num_imagen,fecha,url_imagen):
...
def lista_porcentaje_distancia(contador_distancias_prep,valor_maximo):
	...
	#Para cada longitud se determina su porcentaje y se añade al diccionario
...
'''representacion_1_figura_contadores:
	...
	una URL
'''
def representacion_1_figura_contadores(contador,tamaño,ylabel,xlabel,title,num_imagen,fecha,url,limit):
...
'''representacion_distOrigen_distintas_longaspath:
	...
	se añaden por argumento (longitudes)
