...
'''
def representacion_informacion_global_ip(data_ip,tamaño,ylabel1,ylabel2,ylabel3,title1,title2,title3,num_imagen,url,fecha):
    ...
    fig,ax = plt.subplots(nrows = 3, ncols = 1,figsize=tamaño)

	#Se añaden los plots de cada imagen
	...
	#Se añaden caracteristicas de los ejes de cada figura
...
'''
def representacion_dicc_longitud(dicc1,dicc2,tamaño,bar_width,opacity,label1,label2,rotation,ylabel,title,xlabel,url,fecha,num_imagen):
...
title = ""
num_imagen = representacion_1_figura_contadores(contador_longitudes_monitores_ipv4_totales,(10,5),"Número de Monitores",
                                                "Número de Longitudes",title,num_imagen,fecha,url_imagen,"IPv4")
title = ""
num_imagen = representacion_1_figura_contadores(contador_longitudes_monitores_ipv6_totales,(10,5),"Número de Monitores",
                                                "Número de Longitudes",title,num_imagen,fecha,url_imagen,"IPv6")
...
title2 = ""
title3 = ""
num_imagen = representacion_informacion_global_ip(data_ipv4,(15,20),"Número de entradas","Porcentaje","Porcentaje",
                    title1,title2,title3,num_imagen,url_imagen,fecha)

title1 = ""
title2 = ""
title3 = ""
num_imagen = representacion_informacion_global_ip(data_ipv6,(15,20),"Número de entradas","Porcentaje","Porcentaje",
                    title1,title2,title3,num_imagen,url_imagen,fecha)
...
num_imagen = representacion_dicc_longitud(dicc_long27,dicc_long28,(10,5),bar_width,opacity,"Longitud de prefijo 27",
                    "Longitud de prefijo 28","vertical","Número de entradas",title,"Longitud aspath",url_imagen,fecha,num_imagen)
