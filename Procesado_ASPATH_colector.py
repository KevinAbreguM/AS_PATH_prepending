...
Se utiliza para comparar el comportamiento de distintos colectores
...
'''representacion_1_figura_cantidad_prefijos:
	...
	una URL
'''
def representacion_1_figura_cantidad_prefijos(lista,labels,fechas,tamaño,ylabel,xlabel,title,num_imagen,fecha,url):
	...
	#Añado elementos a la figura de tipo plot
...
'''representacion_1_figura_lista:
	...
	una URL
'''
def representacion_1_figura_lista(fechas,fechas2,fechas3,lista,label1,label2,label3,tamaño,ylabel,xlabel,title,num_imagen,fecha,url):
...
'''representacion_1_figura_lista_prep:
	...
	una URL
'''
def representacion_1_figura_lista_prep(lista1,lista2,fechas,labels,tamaño,ylabel,xlabel,title,num_imagen,fecha,url):
...
'''
def representacion_1_figura_numASes_prep(lista1,fechas,tamaño,ylabel,xlabel,title,num_imagen,url,fecha):
