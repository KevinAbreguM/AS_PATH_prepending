...
una determinada fecha (en termino de dias)
@author: kevin
"""
...
'''obtener_ficheros_dia:
		Funcion que tiene como argumentos un colector y una fecha (en formato de años.meses)
...
for rrc_num in range(0,24):
    ...
    if rrc_num != 22:
		...
		#se debe añadir el 0 en caso de que sea un numero de colector menor al 10.
        if rrc_num < 10:
