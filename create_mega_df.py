...
en un dataframe de grandes proporciones.
...
create_mega_dataframe:
	...
	y a un dia, se elimina la informacion no relevante para el proyecto y se añade la longitud de prefijo 
	como parametro.
...
''' add_moreinfo:
	Funcion que añade informacion adicional al dataframe con
