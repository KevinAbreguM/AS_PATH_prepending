...
def representacion_pie(tamaño,lista,labels,title_leyenda,title,num_imagen,fecha,url_imagen,nombre):
	...
	# Se crea la figura y se añaden caracteristicas
	...
	# Se añade la leyenda con caracteristicas de posicion/tamaño
...
def representacion_1_figura_lista_ordenada(lista,tamaño,bar_width,opacity,
	...
	# Se añaden los distintos elementos de la figura
    n_groups = len(lista)
	...
	#Se añaden caracteristicas de los ejes y titulo
    ax.set_xticks([],[])
...
#Listas para añadir la cantidad de prefijos distintos
lista_ipv4 = []
lista_ipv6 = []
