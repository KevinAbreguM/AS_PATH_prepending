...
# -*- coding: utf-8 -*-
"""
Codigo que procesa la informacion de los CSVs a nivel ASes Origen (ASes que originan rutas) y 
...
def informacion_general_monitores(lista_monitores_origen,data_origen):
    ...
    for monitor_origen in lista_monitores_origen:
        ...
        try:
            ...
            socket.inet_aton(monitor_origen)
            ...
            diccionario_monitores_ASes_validos.update({monitor_origen: len(df_monitor)})
			...
			#Almacenamiento de estadisticas de monitor
            diccionario_monitores_ASes_validos_ipv6.update({monitor_origen: len(df_monitor)})
...
lista_info_final_porcentaje = [0,num_algunos_prepending_filt/num_ASes_filt,num_no_prepending_filt/num_ASes_filt]
